...
export const SearchOutlined = ({className, ...rest}) => (
  <Icon component={SearchOutlinedSvg} className={classNames('align-middle', className)} {...rest} />
);
